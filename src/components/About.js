...
const About = () => {
    return (
        <>
        <div className="" style={{background:"url(https://png.pngtree.com/thumb_back/fh260/background/20200714/pngtree-modern-double-color-futuristic-neon-background-image_351866.jpg) no-repeat center center/cover", padding: "152px 60px"}}>
            <div className="container" style={{width:"70%"}}>
            <h1 className='fs-1 text-light mb-3'>
                RECURITERS
            </h1>
