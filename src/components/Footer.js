      ...
      <div className="container d-flex">
        <div className="footer-content   text-center col-md-4">
          <div className='d-flex mx-4'> 
           <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRILMoSCTMTFNSZhct4myfezPrk0754arIvb7IT4TY5IqhFOvF19OuH-INsyER5Ul-rvks&usqp=CAU" alt="Logo" width="60" height="46" className="d-inline-block align-text-top "/>
         <h5 className='mx-4 pt-2'>Coursify Task</h5></div>
    ...
    <div className="container">
      <div className="row">
        <div className="col-md-6">
          <h6>Contact Us</h6>
          <p>If you have any questions, feel free to reach out to us at <Link to="mailto:info@recruitmentcompany.com">info@recruitmentcompany.com</Link></p>
        </div>
